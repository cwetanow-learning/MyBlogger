...
namespace BlogSystem.Tests.Web.ProfileControllerTests
{
    [TestFixture]
    class InitialiseTests
    {
        ...
        public void ConstructorTests_ShouldInitialiseCorrectInstanceOfBase()
        {
            ...
            var mockedCommentRepository = new Mock<ICommentRepository>();

            var controller = new ProfileController(mockedPostRepository.Object, mockedCommentRepository.Object);
